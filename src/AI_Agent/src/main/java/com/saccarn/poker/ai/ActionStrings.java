...
public class ActionStrings {
    ...
    public static final String ACTION_BET1 = "BET1";
    public static final String ACTION_BET2 = "BET2";
    public static final String ACTION_BET3 = "BET3";
    public static final String ACTION_RAISE1 = "RAISE1";
